...
Parameters::Parameters(std::string fileName) {
  ...
  bitfinexEnabled = getBool(getParameter("BitfinexEnabled", configFile));
  ...
  okcoinEnabled = getBool(getParameter("OkCoinEnabled", configFile));
  ...
  bitstampEnabled = getBool(getParameter("BitstampEnabled", configFile));
  ...
  geminiEnabled = getBool(getParameter("GeminiEnabled", configFile));
  ...
  krakenEnabled = getBool(getParameter("KrakenEnabled", configFile));
  ...
  itbitEnabled = getBool(getParameter("ItBitEnabled", configFile));
  ...
  btceEnabled = getBool(getParameter("BTCeEnabled", configFile));
  ...
  poloniexEnabled = getBool(getParameter("PoloniexEnabled", configFile));
